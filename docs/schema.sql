...
CREATE TABLE IF NOT EXISTS "public"."Activity" (
    ...
    "proposal_id" bigint,
    "invoice_id" bigint,
    CONSTRAINT "chk_activity_single_parent" CHECK (("num_nonnulls"("channel_id", "opp_id", "engagement_id", "proposal_id", "invoice_id") = 1))
);
...
CREATE TABLE IF NOT EXISTS "public"."ActivityMaster" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "name" "text" NOT NULL,
    "category" "text" NOT NULL,
    "changes_stage" boolean DEFAULT false NOT NULL,
    "target_stage" "text",
    "sort_order" integer DEFAULT 0 NOT NULL,
    "is_active" boolean DEFAULT true NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "chk_target_stage" CHECK ((("changes_stage" = false) OR (("changes_stage" = true) AND ("target_stage" IS NOT NULL))))
);


ALTER TABLE "public"."ActivityMaster" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."ActivityMasterEntity" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "activity_master_id" "uuid" NOT NULL,
    "entity_type" "text" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "chk_entity_type" CHECK (("entity_type" = ANY (ARRAY['Channel'::"text", 'Opportunity'::"text", 'Engagement'::"text"])))
);


ALTER TABLE "public"."ActivityMasterEntity" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."ActivityMasterEntity"
    ADD CONSTRAINT "ActivityMasterEntity_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."ActivityMasterEntity"
    ADD CONSTRAINT "uq_activity_entity" UNIQUE ("activity_master_id", "entity_type");



ALTER TABLE ONLY "public"."ActivityMasterEntity"
    ADD CONSTRAINT "ActivityMasterEntity_activity_master_id_fkey" FOREIGN KEY ("activity_master_id") REFERENCES "public"."ActivityMaster"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."Activity"
    ADD CONSTRAINT "Activity_activity_master_id_fkey" FOREIGN KEY ("activity_master_id") REFERENCES "public"."ActivityMaster"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."Activity"
    ADD CONSTRAINT "Activity_channel_id_fkey" FOREIGN KEY ("channel_id") REFERENCES "public"."Channel"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."Activity"
    ADD CONSTRAINT "Activity_engagement_id_fkey" FOREIGN KEY ("engagement_id") REFERENCES "public"."Engagement"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."Activity"
    ADD CONSTRAINT "Activity_invoice_id_fkey" FOREIGN KEY ("invoice_id") REFERENCES "public"."Invoice"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."Activity"
    ADD CONSTRAINT "Activity_opp_id_fkey" FOREIGN KEY ("opp_id") REFERENCES "public"."Opportunity"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."Contact"
    ADD CONSTRAINT "Contact_org_id_fkey" FOREIGN KEY ("org_id") REFERENCES "public"."Organization"("id") ON UPDATE CASCADE ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."Engagement"
    ADD CONSTRAINT "Engagement_proposal_id_fkey" FOREIGN KEY ("proposal_id") REFERENCES "public"."Proposal"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."Invoice"
    ADD CONSTRAINT "Invoice_engagement_id_fkey" FOREIGN KEY ("engagement_id") REFERENCES "public"."Engagement"("id") ON UPDATE CASCADE ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."OpportunityContact"
    ADD CONSTRAINT "OpportunityContact_contact_id_fkey" FOREIGN KEY ("contact_id") REFERENCES "public"."Contact"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."OpportunityContact"
    ADD CONSTRAINT "OpportunityContact_opp_id_fkey" FOREIGN KEY ("opp_id") REFERENCES "public"."Opportunity"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."Opportunity"
    ADD CONSTRAINT "Opportunity_org_id_fkey" FOREIGN KEY ("org_id") REFERENCES "public"."Organization"("id") ON UPDATE CASCADE ON DELETE SET NULL;



ALTER TABLE ONLY "public"."Opportunity"
    ADD CONSTRAINT "Opportunity_source_channel_id_fkey" FOREIGN KEY ("source_channel_id") REFERENCES "public"."Channel"("id") ON UPDATE CASCADE ON DELETE RESTRICT;



ALTER TABLE ONLY "public"."Payment"
    ADD CONSTRAINT "Payment_invoice_id_fkey" FOREIGN KEY ("invoice_id") REFERENCES "public"."Invoice"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."Proposal"
    ADD CONSTRAINT "Proposal_opp_id_fkey" FOREIGN KEY ("opp_id") REFERENCES "public"."Opportunity"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."Task"
    ADD CONSTRAINT "Task_opp_id_fkey" FOREIGN KEY ("opp_id") REFERENCES "public"."Opportunity"("id") ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE "public"."ActivityMaster" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."ActivityMasterEntity" ENABLE ROW LEVEL SECURITY;
...
CREATE POLICY "Enable delete for users based on user_id" ON "public"."Activity" FOR DELETE USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "Enable delete for users based on user_id" ON "public"."Channel" FOR DELETE USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "Enable delete for users based on user_id" ON "public"."Contact" FOR DELETE USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "Enable delete for users based on user_id" ON "public"."Engagement" FOR DELETE USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "Enable delete for users based on user_id" ON "public"."Expense" FOR DELETE USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "Enable delete for users based on user_id" ON "public"."Invoice" FOR DELETE USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "Enable delete for users based on user_id" ON "public"."Opportunity" FOR DELETE USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "Enable delete for users based on user_id" ON "public"."OpportunityContact" FOR DELETE USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "Enable delete for users based on user_id" ON "public"."Organization" FOR DELETE USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "Enable delete for users based on user_id" ON "public"."Payment" FOR DELETE USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "Enable delete for users based on user_id" ON "public"."Proposal" FOR DELETE USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));
...
GRANT ALL ON TABLE "public"."ActivityMaster" TO "anon";
GRANT ALL ON TABLE "public"."ActivityMaster" TO "authenticated";
GRANT ALL ON TABLE "public"."ActivityMaster" TO "service_role";



GRANT ALL ON TABLE "public"."ActivityMasterEntity" TO "anon";
GRANT ALL ON TABLE "public"."ActivityMasterEntity" TO "authenticated";
GRANT ALL ON TABLE "public"."ActivityMasterEntity" TO "service_role";
